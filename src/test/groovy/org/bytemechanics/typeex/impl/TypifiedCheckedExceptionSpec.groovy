...
class TypifiedCheckedExceptionSpec extends Specification {
	...
	def "Build a typified exception without arguments will create the correct exception type"(){
		println(">>>>> TypifiedCheckedExceptionSpec >>>> Build a typified exception without arguments will create the correct exception type")
		setup:
	...
	def "Build a typified exception with cause will create the correct exception type with its correspondent cause"(){
		println(">>>>> TypifiedCheckedExceptionSpec >>>> Build a typified exception with cause will create the correct exception type with its correspondent cause")
		setup:
	...
	def "Build a typified exception with 1 argument will create the correct exception type with its correspondent message"(){
		println(">>>>> TypifiedCheckedExceptionSpec >>>> Build a typified exception with 1 argument will create the correct exception type with its correspondent message")
		setup:
			def TypifiedCheckedException result;
	...
	def "Build a typified exception with 1 argument and case will create the correct exception type with its correspondent message"(){
		println(">>>>> TypifiedCheckedExceptionSpec >>>> Build a typified exception with 1 argument and case will create the correct exception type with its correspondent message")
		setup:
			def Throwable cause=new RuntimeException("My cause");
			def TypifiedCheckedException result;
	...
	def "A Typified exception with 1 argument should be able to create stacktrace into an string correctly"(){
		println(">>>>> TypifiedCheckedExceptionSpec >>>> A Typified exception with 1 argument should be able to create stacktrace into an string correctly")
		setup:
			def TypifiedCheckedException result;
	...
	def "Build a typified exception with arguments will create the correct exception type with its correspondent message"(){
		println(">>>>> TypifiedCheckedExceptionSpec >>>> Build a typified exception with arguments will create the correct exception type with its correspondent message")
		setup:
			def TypifiedCheckedException result;
	...
	def "Build a typified exception with arguments and case will create the correct exception type with its correspondent message"(){
		println(">>>>> TypifiedCheckedExceptionSpec >>>> Build a typified exception with arguments and case will create the correct exception type with its correspondent message")
		setup:
			def Throwable cause=new RuntimeException("My cause");
			def TypifiedCheckedException result;
	...
	def "A Typified exception should be able to create stacktrace into an string correctly"(){
		println(">>>>> TypifiedCheckedExceptionSpec >>>> A Typified exception should be able to create stacktrace into an string correctly")
		setup:
			def TypifiedCheckedException result;
